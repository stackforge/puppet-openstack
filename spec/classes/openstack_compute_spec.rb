  ...
  let :required_params do
    {
      ...
      :sql_connection     => 'mysql://baz:bar@127.0.0.1/nova?charset=utf8',
    }
  end
  ...
  let :default_params do
    {
      ...
      :rabbit_virtual_host   => '/',
      :cinder_sql_connection => 'mysql://baz:bar@127.0.0.1/cinder?charset=utf8',
      :quantum               => false,
  ...
  let :override_params do
    {
      ...
      :cinder_sql_connection => 'mysql://baz2:bar2@127.0.0.1/cinder?charset=utf8',
      :quantum               => false,
  ...
  context 'cinder' do
    ...
    context 'when enabled' do
      ...
      it 'should configure cinder using defaults' do
        should contain_class('cinder::base').with(
          :verbose              => 'False',
          :sql_connection       => 'mysql://baz:bar@127.0.0.1/cinder?charset=utf8',
          :rabbit_password      => 'rabbit_pw',
          :rabbit_virtual_host  => '/'
        )
      end
    ...
    context 'when overriding config' do
      ...
      it 'should configure cinder using override config' do
        should contain_class('cinder::base').with(
          :verbose              => 'True',
          :sql_connection       => 'mysql://baz2:bar2@127.0.0.1/cinder?charset=utf8',
          :rabbit_password      => 'rabbit_pw',
          :rabbit_virtual_host  => '/nova'
        )
      end
