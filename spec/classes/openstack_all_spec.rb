...
#      :ovs_local_ip          => '10.1.0.1',
#      :metadata_shared_secret => 'md_shared_secret',
#      :cinder_db_password    => 'cinder_pass',
#      :cinder_user_password  => 'cinder_pass',
#      :internal_address      => '10.1.0.1',
...
#    context 'with required parameters for Quantum set' do
#      before do
#        params.merge!(
#          :quantum_user_password => 'quantum_user_password',
#          :quantum_db_password   => 'quantum_db_password',
...
#        )
#      end
#      it 'contains openstack::quantum' do
#        should contain_class('openstack::quantum')
#      end
#    end
#
