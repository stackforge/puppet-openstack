...
#
# [user_password]
#   Password used for authtication.
#  (required)
#
# [rabbit_password]
...
#
# [bridge_uplinks]
#   OVS external bridge name and physcial bridge interface tuple.
#   (optional) Defaults to [].
#
# [bridge_mappings]
#   Physcial network name and OVS external bridge name tuple. Only needed for flat and VLAN networking.
#   (optional) Defaults to [].
#
# [auth_url]
...
#
# [ovs_local_ip]
#   Ip address to use for tunnel endpioint.
