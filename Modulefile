...
dependency 'puppetlabs/glance', '>= 2.1.0'
dependency 'puppetlabs/horizon', '>= 2.1.0'
dependency 'puppetlabs/keystone', '>= 2.1.0'
dependency 'puppetlabs/nova', '>= 2.1.0'
dependency 'puppetlabs/cinder', '>= 2.1.0'
dependency 'puppetlabs/swift', '>= 2.1.0'
